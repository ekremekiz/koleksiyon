<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UrunEkle.aspx.cs" Inherits="koleksiyoner.com.UrunEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div id="page-heading"><h1>Ürün Ekle</h1></div>
		...
		<tr>
			...
			<td><asp:TextBox ID="TextBox2" runat="server" class="inp-form"></asp:TextBox></td></td>
			<td></td>
		</tr>
		
            <tr>
			<th valign="top">İlan Süresi</th>
			<td><asp:TextBox ID="TextBox3" runat="server" class="inp-form"></asp:TextBox></td></td>
			<td></td>
		</tr>
	<tr>
	...
	<tr>
	<th>Resim 2</th>
	<td> <asp:FileUpload ID="FileUpload2" runat="server" class="file_1"/> </td>
	...
	<th>Resim 3</th>
	<td>
        <asp:FileUpload ID="FileUpload3" runat="server" class="file_1" /></td>
	<td><div class="bubble-left"></div>
	<div class="bubble-inner">JPEG, GIF 5MB max per image</div>
	<div class="bubble-right"></div></td>
	</tr>
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
			<asp:Button ID="Button1" runat="server" Text=" " class="form-submit" OnClick="Button1_Click1"/>
